...
public class SwampZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public SwampZombieEntityModel(ModelPart root) {
        super(root);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData cloth = leftArm.addChild("cloth", ModelPartBuilder.create(),
                ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        // Hat (invisible bone still required)

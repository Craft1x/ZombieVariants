...
public class BambooZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public BambooZombieEntityModel(ModelPart root) {
        super(root);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        // Brow1
        ModelPartData brow1 = head.addChild("brow1",
                ModelPartBuilder.create(),
        ...
        // Brow2
        ModelPartData brow2 = head.addChild("brow2",
                ModelPartBuilder.create(),
                ModelTransform.pivot(-2.25F, -5.0F, -4.2F)
        );
        ...
        // Bamboo (attached to left arm)
        ModelPartData bamboo = leftArm.addChild("bamboo",
                ModelPartBuilder.create(),
                ModelTransform.pivot(1.0F, 8.0F, -5.0F)
        );

        bamboo.addChild("left_arm_r1",
                ModelPartBuilder.create()
                        .uv(11, 51).cuboid(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 6.0F, new Dilation(0.0F)),
                ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, (float) Math.PI, 0.0F)
        );
        ...
        return TexturedModelData.of(modelData, 64, 64); // Uses the new texture size
    }

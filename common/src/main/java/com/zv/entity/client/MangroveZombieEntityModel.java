...
public class MangroveZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public MangroveZombieEntityModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        // Hat (invisible placeholder)
        root.addChild(EntityModelPartNames.HAT,
                ModelPartBuilder.create(),  // no cuboid
        ...
        cloth.addChild("left_arm_r1",
                ModelPartBuilder.create()
                        .uv(12, 51).cuboid(-1.0F, -3.0F, -3.0F, 2.0F, 4.0F, 5.0F),
                ModelTransform.of(2.0F, 1.0F, 4.0F, 0.0F, (float) Math.PI, 0.0F)
        );
        ...
        root.addChild(EntityModelPartNames.RIGHT_LEG,
                ModelPartBuilder.create()
                        .uv(48, 13).mirrored().cuboid(-2.1F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F).mirrored(false),
                ModelTransform.pivot(-1.9F, 12.0F + pivotOffsetY, 0.0F)
        );

...
public class BadlandsZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public BadlandsZombieEntityModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        float pivotOffsetY = 24.0F; // Aligns with Blockbench model’s body pivot
        ...
        modelPartData.addChild(
                ...
                ModelPartBuilder.create()
                        .uv(1, 34).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.5F)),
                ModelTransform.pivot(0.0F, 0.0F + pivotOffsetY, 0.0F)
        );
        ...
        leftArm.addChild(
                "cloth",
                ModelPartBuilder.create()
                        .uv(12, 51).cuboid(-1.0F, -1.0F, -3.0F, 2.0F, 4.0F, 5.0F, new Dilation(0.0F)),
                ModelTransform.of(2.0F, -1.0F, 4.0F, 0.0F, 3.1416F, 0.0F)
        );

...
public class MushroomZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        float pivotOffsetY = 24.0F; // Adjusted to align with new model’s coordinate system

        ModelPartData head = modelPartData.addChild(
                EntityModelPartNames.HEAD,
                ModelPartBuilder.create()
                        .uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F))
                        .uv(71, 36).cuboid(-5.0F, -14.0F, -5.0F, 10.0F, 3.0F, 10.0F, new Dilation(0.0F))
                        .uv(67, 15).cuboid(-7.0F, -11.0F, -7.0F, 14.0F, 6.0F, 14.0F, new Dilation(0.0F))

...
public class JungleZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public JungleZombieEntityModel(ModelPart root) {
        super(root);
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild(
                ...
                ModelPartBuilder.create()
                        ...
                        .uv(9, 51).cuboid(-1.0F, 4.0F, 2.0F, 4.0F, 6.0F, 6.0F)

...
public class DeepDarkZombieEntityModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public DeepDarkZombieEntityModel(ModelPart root) {
        super(root);
    }
